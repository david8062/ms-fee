...
import com.IusCloud.msFees.config.redis.PermissionRedisService;
import com.IusCloud.msFees.config.security.JwtService;
import com.IusCloud.msFees.config.security.TenantAuthenticationDetails;
import com.IusCloud.msFees.shared.tenant.RequestContext;
import com.IusCloud.msFees.shared.tenant.TenantContext;
import com.IusCloud.msFees.shared.tenant.UserContext;
...
public class TenantFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            if (userId != null) {
                permissionRedisService.getPermissions(UUID.fromString(tenantId), userId)
